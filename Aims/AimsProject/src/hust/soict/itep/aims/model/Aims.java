package hust.soict.itep.aims.model;
...
public class Aims {
    ...
    // Methods
    public static void showMenu() throws LimitExceededException, PlayerException,ResourceNotFoundException{
            for (; ; ) {
                System.out.println("\nAIMS: ");
                System.out.println("--------------------------------");
    ...
    public static void storeUpdate() throws ResourceNotFoundException{
        for (; ; ) {
            store.printStore();
            System.out.println("\nOptions: ");
            System.out.println("--------------------------------");
    ...
    public static void storeMenu() throws LimitExceededException, PlayerException,ResourceNotFoundException {
        for (; ; ) {
            isPlayable = false;
            System.out.println("\nOptions: ");
            System.out.println("--------------------------------");
    ...
    public static void cartMenu() throws PlayerException, ResourceNotFoundException {
        for (; ; ) {
            System.out.println("\nOptions: ");
            System.out.println("--------------------------------");
